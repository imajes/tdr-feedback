...
- **Ask:** Increase overall damage output for Demolitionist (turret, seeker mine, grenade launcher) to close the gap with Vanguard and other DPS specs
  ...
  - **Echoed by:** @hoodlum06243 (Revoker), @zoner41der5012 (zoner41der), @liekong. (liekong), @sedoi3143 (Sedoidead)
  - **Category:** Balance
...
- **Ask:** Rework Field Grenadier's talent tree to align with the spec's actual playstyle (skill-cast-centric, not proc-chance-based)
  - **First raised by:** @zoner41der5012 (zoner41der)
  - **Echoed by:** @ecoboi (iRaze)
  - **Category:** Rework
...
- **Ask:** Allow Field Grenadier / Firepower-scaling skills (grenades, mortar) to benefit from Firepower stat rather than only Engineering
  - **First raised by:** @zoner41der5012 (zoner41der)
  - **Echoed by:** (implicit in @imajes's observation that power delta between specs is too small)
  - **Category:** Balance
...
- **Ask:** Add a second turret, or increase the turret's attack speed / damage to compensate for it being both slow and weak
  - **First raised by:** @sedoi3143 (Sedoidead)
  - **Echoed by:** @jhieswagger1 (Terror) (rate of fire angle), @liekong. (liekong)
  - **Category:** Balance
...
> "Demo HE definitely feels lacking when compared to other dps classes. I would like to see more damage or better frequency of skills to help us keep up with other classes. As it stands vanguards blow us out the water with no effort and from my testing pharma feels much better to use." — @tibballt (tib), 2026-06-04

Frames the core complaint and provides a specific benchmark (Vanguard outperforming Demo with "no effort").

> "I have a fine tuned HE Munitions build: correct gear sets and skill mods, etc. When i switch to Field Grenadier, with the completely wrong gear, bad skill sets... my power only drops by 200. That seems far too small." — @imajes (imajes), 2026-06-04

A concrete, testable observation that suggests spec differentiation is broken at a mechanical level.

> "in FIELD GRENADIER, There is a talent called (Air Burst), it says 'Grants 27% chance of adding 1 additional stack(s) of FIERY when hitting an enemy with a Skill or Grenade.' Bruh as if Demolitionist Skills has low cooldowns to proc this 27% chance?" — @ecoboi (iRaze), 2026-06-14
...
> "The problem with this class is that it's actually balanced, unlike all the others... Either Demos needs to be improved or everyone else needs to be leveled up against him, because, again, if your game didn't have such powerful characters and builds with DBS, all classes would be at least equal." — @sedoi3143 (Sedoidead), 2026-06-17
...
> "Rework field grenadier completely, needs to stand out more... The artillery turret shooting for low damage is ridiculous. The M32A1 grenade launcher skill Shooting 6 mortars at someone and it barely even scratches them just isn't realistic." — @zoner41der5012 (zoner41der), 2026-06-10
